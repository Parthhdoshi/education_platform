...
//             {currentView === 'signup' ? "Join our community today" : "Log in to continue"}
//           </p>
//         </div>
//         <div className="p-8">
//           {currentView === 'signup' ? (
...
//                 <button onClick={goToLogIn} className="text-blue-500 font-medium hover:text-blue-700 transition">
